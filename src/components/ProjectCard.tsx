...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    ...
    >
      {project.heroImage && (
        <div className="aspect-[516/387] w-full overflow-hidden bg-zinc-100 dark:bg-zinc-800">
          <img
      ...
      <div className="p-8">
        <h3 className="text-xl font-semibold text-zinc-900 transition-colors group-hover:text-zinc-600 dark:text-zinc-100 dark:group-hover:text-zinc-300">
          {project.title}
        </h3>
